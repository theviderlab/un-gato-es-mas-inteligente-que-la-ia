...
|-----------|------------|---------|-----------|
| [Position: Levels of AGI for Operationalizing Progress on the Path to AGI](https://arxiv.org/abs/2311.02462) | [Levels of AGI: Progress on the Path to Artificial General Intelligence from Google DeepMind](https://medium.datadriveninvestor.com/levels-of-agi-progress-on-the-path-to-artificial-general-intelligence-from-google-deepmind-ac75c2690116) | [Peter presents Position: Levels of AGI for Operationalizing Progress on the Path to AGI](https://www.youtube.com/watch?v=wT3_wfYeHzE) | |
| [Attention Is All You Need](https://arxiv.org/abs/1706.03762) | [Attention is all you need (in simple terms)](https://medium.com/@orbinsunny/attention-is-all-you-need-in-simple-terms-ee6393956193) | [Atención en los Transformers explicado visualmente](https://www.youtube.com/watch?v=eMlx5fFNoYc), [Breve explicación de los modelos extensos de lenguaje (LLM)](https://www.youtube.com/watch?v=LPZh9BOjkQs), [Pero, ¿qué es un GPT? Introducción visual a los Transformers](https://www.youtube.com/watch?v=wjZofJX0v4M) | [Transformer model from "Attention Is All You Need](https://github.com/tensorflow/tensor2tensor/blob/master/tensor2tensor/models/transformer.py) |
...
| [A Path Towards Autonomous Machine Intelligence](https://openreview.net/pdf?id=BZ5a1r-kVsf), [Revisiting Feature Prediction for Learning Visual Representations from Video](https://arxiv.org/abs/2404.08471) | [A Path Towards Autonomous Machine Intelligence: Exploring Hierachical Predictive Architectures](https://medium.com/@LawrencewleKnight/a-path-towards-autonomous-machine-intelligence-exploring-hierachical-predictive-architectures-48ba2ca950af) | [JEPA - A Path Towards Autonomous Machine Intelligence (Paper Explained)](https://www.youtube.com/watch?v=jSdHmImyUjk), [Yann LeCun Self-Supervised Learning, JEPA, World Models, and the future of AI](https://www.youtube.com/watch?v=yUmDRxV0krg), [Yann Lecun: Meta AI, Open Source, Limits of LLMs, AGI & the Future of AI - Lex Fridman](https://www.youtube.com/watch?v=5t1vTLU7s40&t=2s), [V-JEPA: Revisiting Feature Prediction for Learning Visual Representations from Video (Explained)](https://www.youtube.com/watch?v=7UkJPwz_N_0) | [V-JEPA: Video Joint Embedding Predictive Architecture](https://github.com/facebookresearch/jepa), [I-JEPA](https://github.com/facebookresearch/ijepa), [V-JEPA 2: Self-Supervised Video Models Enable Understanding, Prediction and Planning](https://github.com/facebookresearch/vjepa2) |
| [Video PreTraining (VPT): Learning to Act by Watching Unlabeled Online Videos](https://arxiv.org/abs/2206.11795v1) | [Learning to play Minecraft with Video PreTraining](https://openai.com/index/vpt/) | [Video PreTraining (VPT): Learning to Act by Watching Unlabeled Online Videos (Paper Explained)](https://www.youtube.com/watch?v=oz5yZc9ULAc) | [Video-Pre-Training](https://github.com/openai/Video-Pre-Training) |
| [Mastering diverse control tasks through world models](https://www.nature.com/articles/s41586-025-08744-2) | [World Models: How Dreaming Beats Memorizing in AI](https://blog.delanoe-pirard.com/one-gpu-vs-720-how-dreaming-beats-memorizing-in-ai-d62d837bf4c2) | [Model Based RL Finally Works!](https://www.youtube.com/watch?v=vfpZu0R1s1Y) | [Mastering Diverse Domains through World Models](https://github.com/danijar/dreamerv3) |
